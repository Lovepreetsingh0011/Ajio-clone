...
export default function ProductSlug_M() {
  ...
  return (
    <>
      <div className="w-full h-full flex flex-col items-center ">
        {/* first div include img price offer */}
        ...
        <div className="w-full h-auto flex ">
          <div className="w-[30%]  m-auto">
            <img
              ...
              alt=""
              className="w-[60%] mb-2 m-auto object-fill"
            />
            <img
              src="./productimg/slug/1.avif"
              alt=""
              className="w-[60%] m-auto mb-2 object-cover"
            />
            <img
      ...
      <div className="w-full flex flex-col mt-5">
        ...
        <div className="flex flex-col w-[80%] m-auto items-center ">
          <h2 className="text-hed text-3xl">JANKIT DESIGNER</h2>
          <p className="font-serif text-xl pt-2 text-center">
            Men Printed Regular Fit Shirt with Spread Collar
          </p>
          <p className="text-pri text-lg font-medium ">322 Ratings</p>
        </div>
        {/* Second box include price offer  tax */}
        <div className="w-[80%] m-auto flex flex-col items-center">
          <h2 className="mt-4 text-3xl font-serif">$499</h2>

          <p className=" text-hed flex items-center text-xl">
            MRP{" "}
            <span className=" pl-[2px] line-through text-xl font-serif	">
              $600
            </span>
            <span className="font-semibold text-lg">(80% off) </span>
          </p>
          <p className="text-lg text-gray-500">Price inclusive of all taxes</p>
        </div>
        ...
        <div className="w-[80%] mt-5  m-auto h-auto flex border-[1.5px] border-dotted	">
          ...
          <div className="w-[70%] px-3 flex items-center justify-center ">
            <p className="text-[75%] text-gray-500">
              ...
              <Link to={"#"} className="underline	text-green-800 text-lg">
                View All Products
              </Link>
            </p>
          </div>
        ...
        <div className="w-[65%]  mb-8 mt-8  flex flex-col m-auto items-center">
          <h3 className="text-gray-500 font-serif text-3xl mb-1 ">Beige</h3>

          <div className="w-[90%] h-[7vh]   flex justify-around items-center       ">
            <p className="w-9 h-9 sm:w-11 sm:h-11    rounded-full bg-gray-600"></p>
            <p className="w-9 h-9 sm:w-11 sm:h-11   rounded-full bg-yellow-300"></p>
            <p className="w-9 h-9 sm:w-11 sm:h-11    rounded-full bg-red-500"></p>
            <p className="w-9 h-9 sm:w-11 sm:h-11  rounded-full bg-slate-800"></p>
          </div>
        </div>
      ...
      <div className="  w-full h-auto px-3">
        ...
        <Carousel responsive={Sim_pro_resposive} autoPlay={true}>
      ...
      <div className=" w-full mt-10 mb-10 h-auto px-3">
        <div className="flex justify-center items-center my-5">
          <div className="w-[45%] h-[0.5px] bg-slate-300"></div>
          <h2 className="w-[15%] text-lg text-center font-serif text-gray-700 ">
            Recently Viewed
